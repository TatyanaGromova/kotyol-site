...
(function initWorksSlider() {
  ...
  const slides = [
    ...
    { src: "images/boiler-6.jpg", title: "Пуск и настройка", meta: "Саткинский район", desc: "Настройка режимов работы и проверка безопасности." },
    ...
    { src: "images/chimney-3.jfif", title: "Дымоход и вентканал", meta: "Саткинский район", desc: "Монтаж дымохода и вентиляционного канала по фасаду дома." },
    { src: "images/chimney-4.jfif", title: "Монтаж котла Лемакс", meta: "Саткинский район", desc: "Установка настенного котла Лемакс с подключением и проверкой работы оборудования." },
    { src: "images/chimney-5.jfif", title: "Проход через перекрытие", meta: "Саткинский район", desc: "Узел прохода с теплоизоляцией." },
    { src: "images/chimney-6.jfif", title: "Вентиляционный канал", meta: "г. Сатка", desc: "Монтаж вентиляционного канала по фасаду здания." },
    { src: "images/chimney-7.jfif", title: "Дымоход и вентканал", meta: "Саткинский район", desc: "Монтаж дымохода и вентиляционного канала с креплением по фасаду." },
    { src: "images/otoplenie-1.jpg", title: "Система отопления", meta: "г. Сатка", desc: "Радиаторы и разводка отопления в частном доме." },
    { src: "images/5b8ab3a9-aa66-4bd8-a6a3-e4d6a6e88888.jfif", title: "Сервис газового узла", meta: "Саткинский район", desc: "Очистка и проверка газового узла котла во время сервисного обслуживания." },
  ];
